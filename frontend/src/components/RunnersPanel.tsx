...
export const RunnersPanel: React.FC<RunnersPanelProps> = ({ runnerSetups, loading }) => {
  if (loading) {
    return (
      <div className="runners-panel glass-card animate-fade-in">
        <div className="runners-header">
          <div className="runners-title">
            <span className="runners-icon">🏃</span>
            <span className="font-mono text-gold">ACTIVE RUNNERS DESK</span>
          </div>
        </div>
        <div className="runners-empty font-mono">Loading active runner setups...</div>
      </div>
    );
  }
