...
// ─── SND SIGNAL-BY-SIGNAL PROCESSING AUDIT PIPELINE ─────────────────────────

/**
 * POST /api/admin/signal-audit/trigger
...
router.post('/signal-audit/trigger', async (req: Request, res: Response) => {
  try {
    ...
    const normalizedReport = {
      ...
      download_url: `/api/admin/signal-audit/pdf/${reportData.reportId}?download=true`,
      view_url: `/api/admin/signal-audit/pdf/${reportData.reportId}`
    };
...
/**
 * GET /api/admin/signal-audit/latest
  ...
  try {
    ...
    res.json({
      ...
      report: {
        ...
        download_url: `/api/admin/signal-audit/pdf/${report.id}?download=true`,
        view_url: `/api/admin/signal-audit/pdf/${report.id}`
      }
    });
  } catch (error: any) {
...
/**
 * GET /api/admin/signal-audit/history
...
/**
 * GET /api/admin/signal-audit/pdf/:id
...
/**
 * POST /api/admin/signal-audit/vps-sync
