...
const initialUserProfiles: UserProfile[] = [
  ...
  { id: 'usr_earle', name: 'Earle Ellis', email: 'earleellis3@gmail.com', password: 'temp123', mustChangePassword: true, role: 'trader', tier: 'futures_forex', marketAccess: 'all', status: 'active', createdAt: new Date().toISOString(), lastActive: 'Preloaded 21-Day VIP Trial Pass', preferredMarket: 'Both', riskLimit: '1%', signalsViewed: 0, watchlistCount: 0, isTrial: true, trialExpiresAt: new Date(Date.now() + 21 * 86400000).toISOString(), trialDaysRemaining: 21, trialExpired: false }
];
